export const live = {
  ...
  ko: {
    ...
    answer:
      '1:1 대전을 선택하고 같은 지문 언어의 상대를 찾으세요. 두 사람에게 같은 지문과 3초 시작 카운트다운이 제공됩니다. 원작의 마킹·흐림·점수 규칙이 적용되며 서버가 먼저 완주를 확인한 사람이 승리합니다. 퇴장은 기권입니다. 연결이 끊기면 10초 뒤 종료되며 재접속할 수 없습니다. 운영상 한 대전은 최대 15분입니다.',
    scoresQ: '기록은 어디에 저장되나요?',
    scoresA:
      '솔로 완료 기록은 최근 50개까지 현재 브라우저에만 저장됩니다. 대전에서는 익명 Rust 서버가 입력을 판정해 진행률과 승패를 결정합니다. 대전 요약은 7일간 보관하며 서버 시작 또는 다음 결과 저장 때 만료 기록을 지웁니다. 회원가입과 공개 순위표는 없습니다.',
