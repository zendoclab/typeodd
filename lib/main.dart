          ...
          children: [
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  originText.length==0 ?
                  Text('re - next') : const Text(''),
                  oddCalc==0 || originText.length==0 ?
                  Text(
                    '${oddScore.toString()}',
                    style: commonTextStyle.copyWith(color: Colors.white, fontSize: Theme.of(context).textTheme.headlineSmall?.fontSize ),
                  ) : oddCalc>0 ? Text(
                  ...
                  children: <Widget>[
                    ...
                    Positioned(
                      ...
                      child: SizedBox(
                        width: constraints.maxWidth * 0.75,
                        height: constraints.maxHeight * 0.7,
                        child: originText.length==0 ? Text('re - next') : TextField(
